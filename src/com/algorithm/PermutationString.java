...
public class PermutationString {
	...
	// Method for generating different permutations of the string by means of
	// recursion
	public static void generateRecursivePermutation(String str, int start, int end) {
		...
		if (start == end - 1)
			...
			for (int i = start; i < end; i++) {
				...
				// Recursively calling function generateRecursivePermutation() for rest of the
				// characters
	...
	public static void generateIterativePermutation(String str, String ans) {
		...
		// Iteratively calling the function and adding values to the null string that is
		// "ans";
		int i = 0;
		while (i < str.length()) {
